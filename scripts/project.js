...
document.getElementById("under100").addEventListener('click', function (e) {
    e.preventDefault();
...
function displayProducts(filteredProducts){
    ...
    filteredProducts.forEach(product => {
        ...
        div.innerHTML = `
        <div class="info">
        <img src="${product.image}" alt="${product.name}" width="281" height="187"
        <br>
        <h2>${product.name}</h2>
        <p class="information">Price: $${product.price}</p>
        <p class="information">Delievery Date: ${product.delieveryDate}</p>
        <p class="information">Rating: ${product.rating}</p>
